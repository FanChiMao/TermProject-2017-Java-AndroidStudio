...
public class StudentCursorAdapter extends SimpleCursorAdapter {
    public StudentCursorAdapter(Context context, int layout, Cursor c, String[] from, int[] to, int flags) {
